...
{
    public class RemoveSingleRoleComand : ICommandHandler<ADUserAndRold>
    {

        private readonly IDbController _dbController;
        private readonly SystemSettings _systemSettings;
        // private readonly IMapper _mapper;
        private readonly ILogger<RemoveSingleRoleComand> _logger;
        private readonly IConvertDataTableToObject _convertDataTableToObject;
  //      private readonly IBusPublisher _publisher;
        private readonly ITracer _tracer;
        //private readonly IMessageOutbox _outbox;
        public RemoveSingleRoleComand(IMemoryCache memoryCache, IDbController dbController, ILogger<RemoveSingleRoleComand> logger, IConvertDataTableToObject convertDataTableToObject, ITracer tracer)//, IMessageOutbox outbox, IBusPublisher publisher)
        {
        ...
        public async Task HandleAsync(ADUserAndRold command)
        {
            ...
            try
            {
                entity = await _dbController.SQLExecuteAsync(Sql.DeleteSingleUserRoles, param);
